...
class CycleUpdatedEvent(Event):
    """
    Linear Cycle Updated Event

    This event transforms Linear cycle updated webhook events and extracts relevant
    ...
    def _on_event(self, request: Request, parameters: Mapping[str, Any], payload: Mapping[str, Any] | None = None) -> Variables:
        """
        Transform Linear cycle updated webhook event into structured Variables
        """
