...
class DocumentRemovedEvent(Event):
    """
    Linear Document Removed Event

    This event transforms Linear document removed webhook events and extracts relevant
    ...
    def _on_event(self, request: Request, parameters: Mapping[str, Any], payload: Mapping[str, Any] | None = None) -> Variables:
        """
        Transform Linear document removed webhook event into structured Variables
        """
