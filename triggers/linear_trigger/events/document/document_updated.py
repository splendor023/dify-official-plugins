...
class DocumentUpdatedEvent(Event):
    """
    Linear Document Updated Event

    This event transforms Linear document updated webhook events and extracts relevant
    ...
    def _on_event(self, request: Request, parameters: Mapping[str, Any], payload: Mapping[str, Any] | None = None) -> Variables:
        """
        Transform Linear document updated webhook event into structured Variables
        """
