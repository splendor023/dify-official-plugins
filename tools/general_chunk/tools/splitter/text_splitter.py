...
class TextSplitter(ABC):
    ...
    def split_documents(self, documents: Iterable[dict]) -> list[dict]:
        """Split documents."""
        texts, metadatas = [], []
    ...
    def transform_documents(self, documents: Sequence[dict], **kwargs: Any) -> Sequence[dict]:
        """Transform sequence of documents by splitting them."""
        return self.split_documents(list(documents))

    async def atransform_documents(self, documents: Sequence[dict], **kwargs: Any) -> Sequence[dict]:
