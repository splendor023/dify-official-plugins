...
class HuggingfaceHubLargeLanguageModel(_CommonHuggingfaceHub, LargeLanguageModel):
    ...
    def _get_customizable_model_parameter_rules() -> list[ParameterRule]:
        ...
        max_new_tokens = ParameterRule(
            name="max_new_tokens",
            label={"en_US": "Max New Tokens", "zh_Hans": "最大新标记"},
            type="int",
            help={
        ...
        seed = ParameterRule(
            name="seed",
            label={"en_US": "Random sampling seed", "zh_Hans": "随机采样种子"},
            type="int",
            help={"en_US": "Random sampling seed.", "zh_Hans": "随机采样种子。"},
            required=False,
            precision=0,
        )
        repetition_penalty = ParameterRule(
            name="repetition_penalty",
            label={"en_US": "Repetition Penalty", "zh_Hans": "重复惩罚"},
            type="float",
            help={
